...
import { commentRecipe, createRecipe, deleteRecipe, downvoteRecipe, editCommentRecipe, getAllRecipe, getAllRecipiesForAdmin, getSingleRecipe, publishRecipe, rateRecipe, unpublishRecipe, upvoteRecipe } from "../services/RecipeService";
...
export const useEditCommentRecipe = () => {
    ...
    >({
      ...
      onSuccess: () => {
        ...
        toast.success("Recipe Comment has been successfully updated");
      },
      onError: (error) => {
        toast.error(error.message);
      },
...
export const useDeleteRecipeFromAdmin = () => {
    ...
    return useMutation<any, Error, string>({
      ...
      onSuccess: () => {
        ...
        toast.success("Successfully Delete this Recipe");
      },
      onError: (error) => {
        toast.error(error.message);
      },
